        ...
        if (len > 0) {
            ...
            if (space < len) {
                ...
                while (to_discard > 0) {
                    ...
                    uint32_t removed = ring_buf_get(&data->rx_ringbuf, dummy, chunk);
                    to_discard -= removed;
...
static int wit_hwt906_channel_get(const struct device *dev,
...
/* 实例化 Data 结构体 */
#define WIT_HWT906_DATA_DEFINE(inst)                                    \
    static struct wit_hwt906_data wit_hwt906_data_##inst;
...
#define WIT_HWT906_DEFINE(inst)                                    \
    ...
    SENSOR_DEVICE_DT_INST_DEFINE(inst,                             \
                                 wit_hwt906_init,                  \
                                 NULL,                             \
                                 &wit_hwt906_data_##inst,          \
                                 &wit_hwt906_config_##inst,        \
                                 POST_KERNEL,                      \
